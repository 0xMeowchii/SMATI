                    ...
                    echo "<script>
                            document.addEventListener('DOMContentLoaded', function() {
                                Swal.fire({
                                    ...
                                    var modal = bootstrap.Modal.getInstance(document.getElementById('add-teachers-modal'));
                                    if(modal) modal.hide();
                                });
                            });
                        </script>";
                    ...
                    echo "<script>
                            document.addEventListener('DOMContentLoaded', function() {
                                Swal.fire({
                                    ...
                                    var modal = bootstrap.Modal.getInstance(document.getElementById('edit-teachers-modal'));
                                    if(modal) modal.hide();
                                });
                            });
                        </script>";
                    ...
                    echo "<script>
                            document.addEventListener('DOMContentLoaded', function() {
                                Swal.fire({
                                    ...
                                    var modal = bootstrap.Modal.getInstance(document.getElementById('drop-teachers-modal'));
                                    if(modal) modal.hide();
                                });
                            });
                        </script>";
