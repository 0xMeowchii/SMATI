                    ...
                    echo "<script>
                            document.addEventListener('DOMContentLoaded', function() {
                                Swal.fire({
                                    ...
                                    var modal = bootstrap.Modal.getInstance(document.getElementById('add-students-modal'));
                                    if(modal) modal.hide();
                                });
                            });
                        </script>";
                    ...
                    echo "<script>
                            document.addEventListener('DOMContentLoaded', function() {
                                Swal.fire({
                                    ...
                                    var modal = bootstrap.Modal.getInstance(document.getElementById('edit-students-modal'));
                                    if(modal) modal.hide();
                                });
                            });
                        </script>";
                    ...
                    echo "<script>
                            document.addEventListener('DOMContentLoaded', function() {
                                Swal.fire({
                                    ...
                                    var modal = bootstrap.Modal.getInstance(document.getElementById('drop-students-modal'));
                                    if(modal) modal.hide();
                                });
                            });
                        </script>";
