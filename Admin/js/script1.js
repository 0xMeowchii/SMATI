        ...
        fetch('authentication.php', {
            ...
            .then(data => {
                if (data.success) {
                    ...
                    if (currentRestoreData.modalId) {
                        // Set the ID in the hidden input field
                        const idFieldMap = {
                            'dropStudentModal': 'studentId',
                            'dropTeacherModal': 'teacherId',
                            'dropRegistrarModal': 'registrarId',
                            'dropSubjectModal': 'subjectId',
                            'deleteSchoolyearModal': 'id'
                        };
                        ...
                        setTimeout(() => {
                            const dropModal = new bootstrap.Modal(document.getElementById(currentRestoreData.modalId));
                            dropModal.show();
                        }, 300);
                    }
                } else {
