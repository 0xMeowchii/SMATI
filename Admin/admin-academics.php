...
<body>
    ...
    <main class="main-content">
        ...
        if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['btnAdd'])) {
            ...
            if ($conn) {
                $stmt = $conn->prepare("INSERT INTO subjects (subject, course, teacher_id, yearlevel, schoolyear_id, status) 
                                            VALUES (?, ?, ?, ?, ?, ?)");
                $stmt->bind_param("ssisis", $subjectname, $course, $teacher_id, $yearlevel, $schoolyear_id, $status);
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        echo "<p><strong>Subject Name: </strong><span id='modalSubjectName'></span></p>
                              ...
                              <p><strong>Course: </strong><span id='modalSubjectCourse'></span></p>
